...
\begin{minipage}[t]{0.35\textwidth}
  ...
  \href{https://github.com/lupuffer/puffer}{\ttfamily\fontsize{8.5}{10}\selectfont github.com/lupuffer/puffer}
\end{minipage}
...
\begin{itemize}
  ...
  \item 浙江省微积分竞赛\hspace{6pt}\cvtag{浙江省三等奖}
...
\begin{center}
  ...
  所有项目源码托管于\ \href{https://github.com/lupuffer/puffer}{\textbf{\ttfamily github.com/lupuffer/puffer}}
\end{center}
